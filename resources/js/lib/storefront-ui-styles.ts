...
export const SF_H3 = 'font-poppins text-2xl font-semibold tracking-tight text-black';

export const SF_H4 = 'font-poppins text-sm font-semibold text-[#747474]';

export const SF_MUTED = 'font-poppins text-base font-normal text-[#747474]';
