                ...
                <main>
                    ...
                    <section className="flex flex-col gap-[25px] py-10">
                        <div className="mx-auto w-full max-w-[1440px]">
                            ...
                            <div className="mt-0 flex flex-col gap-6 px-4 sm:px-8 lg:flex-row lg:items-start lg:gap-[18px] lg:px-14">
                                <CollectionFilters
                                    ...
                                    {items.length > 0 ? (
                                        <>
                                            <div
                                                ...
                                                className="collection-product-grid grid w-full grid-cols-2 gap-x-3 gap-y-4 sm:gap-x-4 sm:gap-y-5 lg:grid-cols-3 lg:gap-x-[18px] lg:gap-y-[25px]"
                                            >
                                                {items.map((product) => (
